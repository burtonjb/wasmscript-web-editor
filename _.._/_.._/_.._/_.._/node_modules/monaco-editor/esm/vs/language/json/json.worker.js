(() => {
  ...
  var numberComparator = /* @__PURE__ */ __name((a2, b) => a2 - b, "numberComparator");
  ...
  function validate(n, schema, validationResult, matchingSchemas, context) {
    ...
    function _validateArrayNode(node2) {
      ...
      if (schema.uniqueItems === true) {
        let hasDuplicates = /* @__PURE__ */ __name(function() {
      ...
      matchingSchemas.forEach((s) => {
        if (s.node === node && !s.inverted) {
          ...
          if (typeof schemaPropertyNames === "object" && !schemaPropertyNames.deprecationMessage && !schemaPropertyNames.doNotSuggest) {
            const propertyNameCompletionItem = /* @__PURE__ */ __name((name, enumDescription = void 0) => {
              const proposal = {
                kind: CompletionItemKind2.Property,
                label: name,
  ...
  (() => {
    ...
    var t2 = { 470: (t3) => {
      ...
      }, "resolve"), normalize: /* @__PURE__ */ __name(function(t4) {
      ...
      }, "normalize"), isAbsolute: /* @__PURE__ */ __name(function(t4) {
      ...
      }, "join"), relative: /* @__PURE__ */ __name(function(t4, r3) {
      ...
      }, "relative"), _makeLong: /* @__PURE__ */ __name(function(t4) {
        return t4;
      }, "_makeLong"), dirname: /* @__PURE__ */ __name(function(t4) {
        if (e2(t4), 0 === t4.length)
          return ".";
      ...
      }, "dirname"), basename: /* @__PURE__ */ __name(function(t4, r3) {
      ...
      }, "basename"), extname: /* @__PURE__ */ __name(function(t4) {
        e2(t4);
      ...
      }, "extname"), format: /* @__PURE__ */ __name(function(t4) {
      ...
      }, "format"), parse: /* @__PURE__ */ __name(function(t4) {
        e2(t4);
    ...
    (() => {
      let t3;
      if (r.r(n), r.d(n, { URI: /* @__PURE__ */ __name(() => f2, "URI"), Utils: /* @__PURE__ */ __name(() => P, "Utils") }), "object" == typeof process)
  ...
  function getLanguageService(params) {
    ...
    return {
      ...
      parseJSONDocument: /* @__PURE__ */ __name((document2) => parse3(document2, { collectComments: true }), "parseJSONDocument"),
      newJSONDocument: /* @__PURE__ */ __name((root, diagnostics) => newJSONDocument(root, diagnostics), "newJSONDocument"),
      ...
      findLinks,
      format: /* @__PURE__ */ __name((document2, range, options) => format4(document2, options, range), "format"),
  ...
  if (typeof fetch !== "undefined") {
    defaultSchemaRequestService = /* @__PURE__ */ __name(function(url) {
      return fetch(url).then((response) => response.text());
    }, "defaultSchemaRequestService");
  }
  var JSONWorker = class {
    static {
      __name(this, "JSONWorker");
    }
